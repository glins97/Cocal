...
import kotlinx.android.synthetic.main.fragment_mandados_boulders.view.*
class MandadosBouldersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        for (i in 1..50){
            boulders.add(Boulder("Teto de Vidro", "Casa da Cobra", 4))
        }
